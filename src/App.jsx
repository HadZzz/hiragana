  ...
  return (
    <div className="min-h-screen bg-slate-800 text-white text-center">
      <header className="p-6 mb-8">
        <h1 className="text-2xl font-bold uppercase text-indigo-500">
          Hiragana Quiz
        </h1>
        <div>
      ...
      <div className="text-9xl font-bold mb-8 text-rose-500">
      ...
      <div className="mb-8">
        <form onSubmit={handleSubmit}>
          <input
            ...
            value={input}
            className="block w-24 bg-transparent text-red-500 border-b-2 border-b-white mx-auto outline-none text-center text-6xl pb-2"
          />
        </form>
      </div>
      {error && (
